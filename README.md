...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-28 08:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9ba85c9e-59b7-411d-8bf5-2fe9e5e2626b.git
$ cd 9ba85c9e-59b7-411d-8bf5-2fe9e5e2626b
```
